...
function Services() {
  ...
  return (
    <>
        ...
        <div className="bg-[#f0f2f4] min-h-screen flex flex-col px-2 items-center text-white py-6 md:px-8">
          ...
          >
            ...
            <p className="text-center text-sm sm:text-base lg:text-lg md:py-7 text-white tracking-wide">
              ...
              tailored to your specific needs. auxzon can be your trusted
              partner to provide trends and strategies to help your business
      ...
      <div className="w-full h-auto py-5 md:mt-10 px-5 border ">
