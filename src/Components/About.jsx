...
const About = () => {
  ...
  return (
    <>
      ...
      <div
        className=" h-auto px-5 py-5  flex rounded-lg md:h-72 flex-col md:flex-row gap-10 justify-center items-center shadow-lg mb-10 md:py-[200px]  "
